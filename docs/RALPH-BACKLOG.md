...
| 11 | App Intents for Lock Screen workout control | 7 | S | 2 | ios | pr-open | Modern `AppIntent` family (Start/Pause/Resume/End) + Lock Screen Start Workout widget. Seam for #10. PR: _pending push_. |
