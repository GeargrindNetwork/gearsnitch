...
| 8 | External HR sensor intake on iPhone (BLE HR profile + Powerbeats Pro 2) | 8 | S | 2 | ios | pr-open | iOS 26 HKLiveWorkoutDataSource. Expands Watch-less cohort. PR: [#58](https://github.com/GeargrindNetwork/gearsnitch/pull/58) |
