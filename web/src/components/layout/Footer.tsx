      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-zinc-500 transition-colors hover:text-white">About</a></li>
              <li><a href="#" className="text-zinc-500 transition-colors hover:text-white">Blog</a></li>
              <li><a href="#" className="text-zinc-500 transition-colors hover:text-white">Careers</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-zinc-500 transition-colors hover:text-white">Privacy</a></li>
              <li><a href="#" className="text-zinc-500 transition-colors hover:text-white">Terms</a></li>
              <li><a href="#" className="text-zinc-500 transition-colors hover:text-white">Contact</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="text-zinc-600 transition-colors hover:text-white" aria-label="Instagram">
            ...
            <a href="#" className="text-zinc-600 transition-colors hover:text-white" aria-label="TikTok">
