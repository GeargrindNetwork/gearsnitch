...
export default function Footer() {
  return (
    <footer className="border-t border-border bg-muted/40 dark:bg-zinc-950">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-foreground">
                Gear<span className="text-cyan-600 dark:text-cyan-400">Snitch</span>
              </span>
            </Link>
          ...
          {/* Product */}
          <div>
            <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-foreground/80">Product</h3>
            <ul className="space-y-2 text-sm">
              <li><a href="/#features" className="text-muted-foreground transition-colors hover:text-foreground">Features</a></li>
              <li><Link to="/store" className="text-muted-foreground transition-colors hover:text-foreground">Store</Link></li>
              <li><a href="#download" className="text-muted-foreground transition-colors hover:text-foreground">Download</a></li>
            </ul>
          </div>
          ...
          {/* Legal */}
          <div>
            <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-foreground/80">Legal</h3>
            <ul className="space-y-2 text-sm">
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/GeargrindNetwork/gearsnitch" target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-foreground" aria-label="GitHub">
            ...
            <a href="mailto:hello@gearsnitch.com" className="text-muted-foreground transition-colors hover:text-foreground" aria-label="Email">
