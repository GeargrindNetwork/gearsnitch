/**
 * Landing variant v1 — the control (item #36).
 *
 * This is the existing landing page, factored out verbatim so that the
 * `<LandingPage />` route can A/B-bucket between v1 and v2 via
 * `useLandingVariant`. Copy and layout here should remain stable until the
 * experiment concludes so control metrics are comparable.
 */
...
export default function LandingV1() {
  return (
    ...
    <div className="dark min-h-screen bg-black text-white" data-landing-variant="v1">
      <Header />
